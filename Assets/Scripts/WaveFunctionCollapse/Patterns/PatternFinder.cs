...
namespace WaveFunctionCollapse.Patterns
{
    public static class PatternFinder
    {
        ...
        {
            Dictionary<string, PatternData> patternHashcodeDictionary = new();
            Dictionary<int, PatternData> patternIndexDictionary = new();
            ...
            for (int row = rowMin; row < rowMax; row++)
            {
                for (int col = colMin; col < colMax; col++)
                {
                    ...
                    {
                        Pattern pattern = new(gridValues, hashValue, patternIndex);
                        patternIndex++;
        ...
        {
            PatternNeighbours patternNeighbours = new();
